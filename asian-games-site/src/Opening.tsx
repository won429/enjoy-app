...
export default function Opening({progress}:{progress:MotionValue<number>}){
 ...
 useMotionValueEvent(progress,'change',p=>setClubIndex(Math.min(9,Math.floor(p/.014))));
